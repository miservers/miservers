...
void pic_8259a_init()
{
   ...
   outb_p(0x70, PIC2_DATA);  // Set the slave PIC's base offset to 96
   
   /*Cascade identity with slave PIC at IRQ2 */
   outb_p(0x04, PIC1_DATA);  // ICW3
   outb_p(0x02, PIC2_DATA); 
   ...
   /*OCW1*/
   outb_p(0xFC, PIC1_DATA); // OCW4 master. 11111100b. enable (clear bit) irq0 and irq1 and disable other(set bit) 
   outb_p(0xA7, PIC2_DATA); // OCW4 slave. 10100111b. ebable irq11/12/14 and disable others.  
